...
<body>
    ...
    <nav id="topBar" class="navbar navbar-expand-lg navbar-dark">
        ...
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link" href="" id="sign-up-nav-btn" data-toggle="modal" data-target="#modalWelcome">Sign
                    up</a>
            </li>
            <li class="nav-item">
                                    ...
                                    <form method="POST" action="{{ route('login') }}" id="loginForm">
                                        ...
                                        <div class="row d-flex justify-content-lg-center">
                                            <div class="col-lg-10 mb-4">
                                                ...
                                                <input id="emailLogin" name="email" type="email" class="form-control"
                                            ...
                                            <div class="row d-flex justify-content-center">
                                                ...
                                                <div class="row d-flex justify-content-lg-center mb-2">
                                                    ...
                                                    <div class="col sign-up-input">
                                                        ...
                                                        <input class="form-control" type="text" placeholder="Last Name"
                                                            id="lastNameSignUp" name="lastName" required>
                                                    </div>
                                                </div>
                                                <div class="row d-flex justify-content-lg-center mb-2">
                                                    <div class="col sign-up-input">
                                                ...
                                                <div class="row d-flex justify-content-lg-center mb-2">
                                                    <div class="col sign-up-input">
                                                        ...
                                                        <input type="password" id="passwordSignUp" name="password"
                                                            ...
                                                            pattern="(?=.*\d)(?=.*[a-zA-Z]).{6,}" placeholder="Password"
                                                            required>
                                                ...
                                                <div class="row d-flex justify-content-lg-center mb-2">
                                                    <div class="col sign-up-input">
                                                        ...
                                                        <select class="form-control" id="genderSignUp" name="gender">
                                                ...
                                                <div class="form-group row login-signup-trans mt-4">
                                                    ...
                                                    <button type="submit" onclick="" class="btn btn-outline-dark">Sign
                                                        up</button>
