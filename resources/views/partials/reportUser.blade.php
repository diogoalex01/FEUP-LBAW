    ...
    <div class="user-report report card mb-4 post-container">
        <div class="card-body">
            ...
            <a href="{{ route('admin.profile', $report->reported->id) }}">
                <img height="35" width="35" class="profile-pic-small" src="{{ asset($report->reported->photo) }}" alt="Profile Image">
        ...
        <div class="card-footer row text-muted mx-0">
            <div class="col-md-6 align-self-center">
                <div class="card-footer-buttons row align-content-center justify-content-start">
                    <a href="#" class="admin-delete" data-type='user' data-object='{{$report->reported->id}}'><i class="fas fa-ban"></i>Ban User</a>
                </div>
            </div>
            <div class="col-md-6">
                <div class="row align-self-center justify-content-end">
                    <a href="{{ route('admin.profile', $report->report->reporter->id)}}">
                        <img height="35" width="35" class="profile-pic-small" src="{{ asset($report->report->reporter->photo) }}"
                            alt="Profile Image">
                    </a>
