    ...
    <div class="card-body">
        <div class="row">
            <div class="col justify-content-start">
                <div id="admin_menu" class="admin-aside nav-border-active">
                    <i class="fas fa-globe-europe mr-2"></i>
                    All</div>
                <div id="users_menu" class="admin-aside nav-border">
                    <i class="fas fa-user mr-2"></i>
                    Users</div>
                <div id="comments_menu" class="admin-aside nav-border">
                    <i class="fas fa-comments mr-2"></i>
                    Comments</div>
                <div id="posts_menu" class="admin-aside nav-border">
