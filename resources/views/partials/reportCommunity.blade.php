        ...
        <div class="card-footer row text-muted mx-0">
            <div class="col-md-6 align-self-center">
                <div class="card-footer-buttons row align-content-center justify-content-start">
                    <a href="" class="admin-delete" data-type='community' data-object='{{$report->community->id}}'><i
            ...
            <div class="col-md-6">
                <div class="row align-self-center justify-content-end">
                    ...
                    <a>@unknown</a>
                    @else
                    <a href="" class="align-self-center" href="{{ route('admin.profile', $report->report->reporter->id) }}">
