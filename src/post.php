...
<div class="container">
    ...
    <div class="col-md-12">
        ...
        <div class="card mb-4 post-container">
            <img class="card-img-top pl-5 pr-5 pt-5 pb-2 m-0" src="https://s31450.pcdn.co/wp-content/uploads/2017/08/iStock-157735020-170828.jpg" alt="Post Image">
                    ...
                    <div class="col-md-10 mx-auto">
                        <div style="padding-top: 15px;">
                            ...
                            <p class="card-text post-body">
                                Hello i am desperately trying to find a way
                                ...
                                any
                                umm
                                i dont know tip or how to it would be nice.
                                <p>
                                    Thank you.
                                </p>
                            </p>
            ...
            <div class="card-body">
                <div class="row" style="font-size: 0.45rem;">
                    <div class="col-md-10 pr-md-0">
                        ...
                        <textarea rows="1" onclick="this.rows = '8';" onblur="if(this.value == '') this.rows = '1';" type="text" class="form-control mr-0" placeholder="New Comment"></textarea>
                    </div>
        ...
        <?php post_comment($auth, "c1", "someusername", "myProfile.php", "./images/avatar_male.png", "March 5, 2020", 12, 2, "Personally, it depends what you are studying but for
                        ...
                        in
                        your
                        textbook) is the best way to learn.", "post-comment") ?>
        ...
        <?php post_comment($auth, "c1", "someotherusername", "userProfile.php", "./images/avatar_female.png", "March 5, 2020", 12, 2, "It is Computer Science but yeah my main issue is maths i tried going to
                        every
                        election - writing down every single thing (even if i don't understand a single thing)
                        and then
                        going home realizing that i cant understand anything. I may be low on IQ or something i
                        dont
                        know.
                        Thanks for the reply", "post-reply") ?>
        ...
        <?php post_comment($auth, "c2", "someusername", "myProfile.php", "./images/avatar_male.png", "March 5, 2020", 34, 2, "It can be a bit overwhelming at first, but there's definitely a system to
                        learn
                        effectively. And that is regardless of the course and the amount of work.", "post-comment") ?>
