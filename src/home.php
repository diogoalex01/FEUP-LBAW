    ...
    <div class="row" style="padding: 20 0;">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col justify-content-start">
                            ...
                            <a href="trendingHome.php?auth=<?= $auth ?>&admin=<?= $admin ?>">
        ...
        <div class="col-md-9">
            ...
            <?php home_post($auth, "someusername", "myProfile.php", "./images/avatar_male.png", "/Porto", "March 5, 2020", 12, 2, "https://s31450.pcdn.co/wp-content/uploads/2017/08/iStock-157735020-170828.jpg", "Problem with studying.", "Hello i am desperately trying to find a way
                                        ...
                                        in the first semester of my CS uni and i just realised that i dont know how to start learning a new course. I tried reading the provided book / searching on
                                        internet but when it comes to the homework i dont know a single thing...So please if you have
                                        any umm i dont know tip or how to it would be nice. <br>
                                        Thank you.", $admin); ?>
