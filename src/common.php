                    ...
                    <section>
                        <div class="container mb-3">
                            ...
                            <div class="row justify-content-end my-2 mx-1">
                                ...
                                <button class="btn btn-secondary my-2 mr-1" data-toggle="modal" data-dismiss="modal" data-target="#modalLogin">Close</button>
                                <button class="btn btn-danger my-2 ml-1" data-toggle="modal" data-dismiss="modal" data-target="#modalLogin">Send
                                    Report</button>
                            </div>
                        </div>
                    </section>
                ...
                <div class="modal-body login-modal">
                    ...
                    <section>
                        <div class="container mb-3">
                            ...
                            <div class="row justify-content-end my-2 mx-1">
                                <button class="btn btn-outline-dark my-2 mr-1" data-toggle="modal" data-dismiss="modal" data-target="#modalLogin">Close</button>
                                <button class="btn btn-danger my-2 ml-1" data-toggle="modal" data-dismiss="modal" data-target="#modalLogin">Send
                                    Report</button>
                            </div>
                        </div>
...
{ ?>
    ...
    <!-- Modal -->
    <div class="modal p-0" id="modalWelcome" tabindex="-1" role="dialog" aria-labelledby="modalWelcomeTitle" aria-hidden="true">
                        ...
                        <div>
                            <section>
                                <div class="container mb-3">
                                    ...
                                    <div>
                                        <div class="d-flex justify-content-center">
                                            <button class="btn btn-secondary my-2" data-toggle="modal" data-dismiss="modal" data-target="#modalLogin">Continue
                                                with Email</button>
                                        </div>
                                        <div class="d-flex justify-content-center">
                                    ...
                                    <div class="row d-flex justify-content-center">
                                        <div class="row d-flex justify-content-lg-center mb-2">
                                            <div class="col sign-up-input">
                                                ...
                                                <input id="nameInput" class="form-control" type="text" placeholder="First Name">
                                            </div>
                                            <div class="col sign-up-input">
                                                <label for="nameInput" class=" control-label">Last name:</label>
                                                <input id="nameInput" class="form-control" type="text" placeholder="Last Name">
                                            </div>
                                        </div>
                                        <div class="row d-flex justify-content-lg-center mb-2">
                                            <div class="col sign-up-input">
                                        ...
                                        <div class="row d-flex justify-content-lg-center mb-2">
                                            ...
                                            <div class="col sign-up-input">
                                                ...
                                                <input type="password" id="passver" class="form-control" aria-describedby="passwordHelp" pattern="(?=.*\d)(?=.*[a-zA-Z]).{6,}" placeholder="Password" required>
                                                <div class="invalid-feedback">
                                                    Required!
                                                </div>
                                            </div>
